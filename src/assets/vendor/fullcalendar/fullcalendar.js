...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	computeTitleFormat: function() { /* arm-marked */
	...
	buildGotoAnchorHtml: function(gotoOptions, attrs, innerHtml) {
		...
		finalOptions = { // for serialization into the link
			date: date.format('YYYY-MM-DD'), /* arm-edited */
...
Calendar.defaults = {
	...
	titleRangeSeparator: ' \u2013 ', // en dash
	 monthYearFormat: 'MMMM [พ.ศ. '+(new Date().getFullYear()+543)+']', // arm-edited
	// monthYearFormat: '[วัน]dddd[ที่] Do MMMM YYYY', // required for en. other locales rely on datepicker computable option
...
function Header(calendar) {
	...
	function updateTitle(text) { /* arm-edited */
		var splitText = text.split(' ');
		var yearToChange = +splitText[splitText.length-1]+543;
		var textToChange = text.substring(0, text.lastIndexOf(' '))+' '+yearToChange;
		if (el) {
			el.find('h2').text(textToChange);
		}
	}
