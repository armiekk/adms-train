    ...
    this.programList = [
      ...
      },
      {
        ...
        subProgram: [
          ...
          { name: 'CMMI Document', id: 'QAD2R010', uri: '/qad/QAD2R010' },
        ]
      },
      {
        moduleName: 'QA CHECKLIST',
        subProgram: [
          { name: 'QA Checklist', id: 'QAD3I010', uri: '/qad/QAD3I010' },
          { name: 'Checklist Search', id: 'QAD3Q010', uri: '/qad/QAD3Q010' },
          { name: 'CMMI Document', id: 'QAD3R010', uri: '/qad/QAD3R010' },
        ]
      },
      {
        moduleName: 'Audit PROGRAMS',
        subProgram: [
          { name: 'Audit Programs', id: 'QAD4I010', uri: '/qad/QAD4I010' },
          { name: 'Audit Programs Search', id: 'QAD4Q010', uri: '/qad/QAD4Q010' },
          { name: 'CMMI Document', id: 'QAD4R010', uri: '/qad/QAD4R010' },
        ]
      },
      {
        moduleName: 'QA REPORT',
        subProgram: [
          { name: 'Audit Programs', id: 'QAD2R010', uri: '/qad/QAD2R010' },
          { name: 'Audit Programs Search', id: 'QAD2Q010', uri: '/qad/QAD2Q010' },
          { name: 'QA Metrics', id: '', uri: '' },
          { name: 'QA Audit Project', id: '', uri: '' },
          { name: 'QA Summary Checklist', id: 'QAD3R010', uri: '/qad/QAD3R010' },
        ]
      },
      {
        ...
        subProgram: [
          { name: 'QA MENU', id: '', uri: '' },
          { name: 'QA Activities', id: 'QAD0Q010', uri: '/qad/QAD0Q010' },
